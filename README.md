...
<title>Phonétique française</title>
...
<header>
  <h1>Phonétique française</h1>
  <p>Son isolé · Mot exemple</p>
</header>
...
<p class="footer">
  🔊 Son isolé : <a href="https://en.wikipedia.org/wiki/Help:IPA" target="_blank">Wikipedia Help:IPA</a> · Wikimedia Commons (CC)<br>
  📖 Mot exemple : synthèse vocale du navigateur (fr-FR)
</p>
...
const SECTIONS = [
  {
    ...
    cards: [
      { ipa:'i',  word:'v<b>ie</b>',    wordText:'vie',    type:'fermée antérieure',      col:'#c8a96e', url:au('9/91','Close_front_unrounded_vowel.ogg') },
      { ipa:'e',  word:'<b>é</b>té',    wordText:'été',    type:'mi-fermée antérieure',   col:'#c8a96e', url:au('6/6c','Close-mid_front_unrounded_vowel.ogg') },
      { ipa:'ɛ',  word:'f<b>ê</b>te',   wordText:'fête',   type:'mi-ouverte antérieure',  col:'#c8a96e', url:au('7/71','Open-mid_front_unrounded_vowel.ogg') },
      { ipa:'a',  word:'p<b>a</b>tte',  wordText:'patte',  type:'ouverte antérieure',     col:'#c8a96e', url:au('6/65','Open_front_unrounded_vowel.ogg') },
      { ipa:'ɑ',  word:'p<b>â</b>te',   wordText:'pâte',   type:'ouverte postérieure',    col:'#c8a96e', url:au('e/e5','Open_back_unrounded_vowel.ogg') },
      { ipa:'ɔ',  word:'<b>o</b>r',     wordText:'or',     type:'mi-ouverte postérieure', col:'#c8a96e', url:au('0/02','Open-mid_back_rounded_vowel.ogg') },
      { ipa:'o',  word:'b<b>eau</b>',   wordText:'beau',   type:'mi-fermée postérieure',  col:'#c8a96e', url:au('8/84','Close-mid_back_rounded_vowel.ogg') },
      { ipa:'u',  word:'r<b>ou</b>e',   wordText:'roue',   type:'fermée postérieure',     col:'#c8a96e', url:au('5/5d','Close_back_rounded_vowel.ogg') },
      { ipa:'y',  word:'l<b>u</b>ne',   wordText:'lune',   type:'fermée ant. arrondie',   col:'#c8a96e', url:au('e/ea','Close_front_rounded_vowel.ogg') },
      { ipa:'ø',  word:'f<b>eu</b>',    wordText:'feu',    type:'mi-fermée arrondie',     col:'#c8a96e', url:au('5/53','Close-mid_front_rounded_vowel.ogg') },
      { ipa:'œ',  word:'p<b>eu</b>r',   wordText:'peur',   type:'mi-ouverte arrondie',    col:'#c8a96e', url:au('0/00','Open-mid_front_rounded_vowel.ogg') },
      { ipa:'ə',  word:'l<b>e</b>',     wordText:'le',     type:'schwa',                  col:'#c8a96e', url:au('d/d9','Mid-central_vowel.ogg') },
    ]
  },
  {
    label: 'Voyelles nasales', sub: '4 sons',
    cards: [
      { ipa:'ɑ̃', word:'v<b>en</b>t',   wordText:'vent',   type:'nasale centrale',        col:'#7eb8c9', url:au('0/0e','Fr-en.ogg') },
      { ipa:'ɛ̃', word:'v<b>in</b>',    wordText:'vin',    type:'nasale antérieure',      col:'#7eb8c9', url:'https://upload.wikimedia.org/wikipedia/commons/transcoded/6/6a/Fr-Un-fr_FR-Paris.ogg/Fr-Un-fr_FR-Paris.ogg.mp3' },
      { ipa:'œ̃', word:'br<b>un</b>',   wordText:'brun',   type:'nasale ant. arrondie',   col:'#7eb8c9', url:'https://upload.wikimedia.org/wikipedia/commons/transcoded/3/3a/Fr-un-fr_BE.ogg/Fr-un-fr_BE.ogg.mp3' },
      { ipa:'ɔ̃', word:'b<b>on</b>',    wordText:'bon',    type:'nasale postérieure',     col:'#7eb8c9', url:au('3/38','Fr-on.ogg') },
    ]
  },
  {
    ...
    cards: [
      ...
      { ipa:'w',  word:'<b>ou</b>i',    wordText:'oui',    type:'labio-vélaire',          col:'#7ec9a0', url:au('f/f2','Voiced_labio-velar_approximant.ogg') },
      { ipa:'ɥ',  word:'n<b>ui</b>t',   wordText:'nuit',   type:'labio-palatale',         col:'#7ec9a0', url:`${W}/3/32/LL-Q150_(fra)-WikiLucas00-IPA_\u0265.wav` },
    ]
  },
  {
    label: 'Consonnes', sub: '17 sons',
    cards: [
      { ipa:'p',  word:'<b>p</b>ère',   wordText:'père',   type:'bilabiale sourde',       col:'#b87ec9', url:au('5/51','Voiceless_bilabial_plosive.ogg') },
      { ipa:'b',  word:'<b>b</b>eau',   wordText:'beau',   type:'bilabiale voisée',       col:'#b87ec9', url:au('2/2c','Voiced_bilabial_plosive.ogg') },
      { ipa:'t',  word:'<b>t</b>ête',   wordText:'tête',   type:'dentale sourde',         col:'#b87ec9', url:au('0/02','Voiceless_alveolar_plosive.ogg') },
      { ipa:'d',  word:'<b>d</b>ire',   wordText:'dire',    type:'dentale voisée',         col:'#b87ec9', url:au('0/01','Voiced_alveolar_plosive.ogg') },
      { ipa:'k',  word:'<b>c</b>as',    wordText:'cas',    type:'vélaire sourde',         col:'#b87ec9', url:au('e/e3','Voiceless_velar_plosive.ogg') },
      { ipa:'g',  word:'<b>g</b>are',   wordText:'gare',   type:'vélaire voisée',         col:'#b87ec9', url:au('b/b4','Voiced_velar_plosive.ogg') },
      { ipa:'f',  word:'<b>f</b>eu',    wordText:'feu',    type:'labio-dentale sourde',   col:'#b87ec9', url:au('3/33','Voiceless_labiodental_fricative.ogg') },
      { ipa:'v',  word:'<b>v</b>in',    wordText:'vin',    type:'labio-dentale voisée',   col:'#b87ec9', url:au('8/85','Voiced_labiodental_fricative.ogg') },
      { ipa:'s',  word:'<b>s</b>ol',    wordText:'sol',    type:'sibilante sourde',       col:'#b87ec9', url:au('a/ac','Voiceless_alveolar_sibilant.ogg') },
      { ipa:'z',  word:'<b>z</b>éro',   wordText:'zéro',   type:'sibilante voisée',       col:'#b87ec9', url:au('c/c0','Voiced_alveolar_sibilant.ogg') },
      { ipa:'ʃ',  word:'<b>ch</b>at',   wordText:'chat',   type:'palatale sourde',        col:'#b87ec9', url:au('c/cc','Voiceless_palato-alveolar_sibilant.ogg') },
      { ipa:'ʒ',  word:'<b>j</b>our',   wordText:'jour',   type:'palatale voisée',        col:'#b87ec9', url:au('3/30','Voiced_palato-alveolar_sibilant.ogg') },
      ...
      { ipa:'ɲ',  word:'a<b>gn</b>eau', wordText:'agneau', type:'nasale palatale',        col:'#b87ec9', url:au('4/46','Palatal_nasal.ogg') },
      { ipa:'l',  word:'<b>l</b>une',   wordText:'lune',   type:'latérale dentale',       col:'#b87ec9', url:au('b/bc','Alveolar_lateral_approximant.ogg') },
      { ipa:'ʁ',  word:'<b>r</b>ue',    wordText:'rue',    type:'fricative uvulaire',     col:'#b87ec9', url:au('a/af','Voiced_uvular_fricative.ogg') },
    ]
  },
];
...
SECTIONS.forEach(({ label, sub, cards }) => {
  ...
  cards.forEach(({ ipa, word, wordText, type, col, url }) => {
    ...
    el.innerHTML = `
      ...
      <div class="btn-row">
        <button class="btn btn-sound" title="Son isolé">🔊 Son</button>
        <button class="btn btn-word"  title="Mot exemple">📖 Mot</button>
      </div>
    `;
    ...
    // 🔊 Isolated sound (Wikimedia audio)
    let playing = null;
